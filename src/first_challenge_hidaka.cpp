// first_challenge_hidaka.hppをインクルード
// ここに書く
#include "first_challenge_hidaka/first_challenge_hidaka.hpp"

FirstChallenge::FirstChallenge() : Node("first_challenge_hidaka")
{
    // global変数を定義
...
void FirstChallenge::run(float velocity, float omega)
{
    ...
    cmd_vel_.cntl.linear.y = velocity; 
